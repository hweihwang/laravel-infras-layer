...
use Support\Events\DomainEventInterface;
use Support\Models\AbstractSearchableModel;

class SearchAndPublishableEvent extends AbstractSearchableModel implements DomainEventInterface, ShouldPublish
{
    use Publishable;
